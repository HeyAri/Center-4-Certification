    ...
    <div class="container-fluid" style="padding:12px;">
        <div class="col-sm-2 text-center">
            <a href="HTTP://center4certs.org" class="navbar-logo">
                <img src="assets/images/c4c-logo-2000x1241.png" alt="Center For Certification" title="Center For Certification" width="100px">
            </a>
            <br />
            <br />
            <button class="btn btn-primary" onClick="window.print()">Print Certificate</button>
            <button class="btn btn-primary" onClick="window.print()">Download as a PDF</button>
        </div>
        <div class="col-sm-10 text-center">
            <img src="images/C4C-<?php echo $_POST['certColor']; ?>.png">
            <div align="center" style="position: absolute; left: 311px; top: 210px; width: 418px; height: 429px;" width="1000" text-align: center; padding:20px>
